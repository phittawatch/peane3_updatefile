...
try {
    // Function to check if a switch is up or down using cURL
    ...
    foreach ($rows as $row) {
        ...
        $dellStatus = isSwitchUp($row['dell_ip']);
        $riujieStatus = isSwitchUp($row['riujie_ip']);
        $watchguardStatus = isSwitchUp($row['watchguard_ip']);
        $zerotrustStatus = isSwitchUp($row['zerotrust_ip']);
        $fortigateStatus = isSwitchUp($row['fortigate_ip']);
